...
![Version](https://img.shields.io/badge/version-0.2b-yellow.svg?style=square)
...
* prefixes: Adding default gotator prefixes to permutations. If no perm list is specified, the default list is used. If perm is specified and this flag is present, the content is added to the permutations.
...
```
gotator -sub domains.txt -perm permutations.txt -depth 3 -numbers 10 | sort -u > output2.txt
```
